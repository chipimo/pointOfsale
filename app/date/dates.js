...
var getBeginOfCenturyYear = (exports.getBeginOfCenturyYear = function getBeginOfCenturyYear(
  date
) {
...
var getBeginOfCentury = (exports.getBeginOfCentury = function getBeginOfCentury(
  date
) {
...
var getEndOfCentury = (exports.getEndOfCentury = function getEndOfCentury(
  date
) {
  var beginOfCenturyYear = getBeginOfCenturyYear(date);
...
var getCenturyRange = (exports.getCenturyRange = function getCenturyRange(
  date
) {
  return [getBeginOfCentury(date), getEndOfCentury(date)];
});

var getBeginOfPreviousCentury = (exports.getBeginOfPreviousCentury = function getBeginOfPreviousCentury(
  date
) {
...
var getEndOfPreviousCentury = (exports.getEndOfPreviousCentury = function getEndOfPreviousCentury(
  date
) {
  var previousCenturyYear = getYear(date) - 100;
...
var getBeginOfNextCentury = (exports.getBeginOfNextCentury = function getBeginOfNextCentury(
  date
) {
...
var getBeginOfDecadeYear = (exports.getBeginOfDecadeYear = function getBeginOfDecadeYear(
  date
) {
  var year = getYear(date) - 1;
...
var getBeginOfDecade = (exports.getBeginOfDecade = function getBeginOfDecade(
  date
) {
...
var getBeginOfPreviousDecade = (exports.getBeginOfPreviousDecade = function getBeginOfPreviousDecade(
  date
) {
  var offset =
...
var getEndOfPreviousDecade = (exports.getEndOfPreviousDecade = function getEndOfPreviousDecade(
  date
) {
  var offset =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
...
var getBeginOfNextDecade = (exports.getBeginOfNextDecade = function getBeginOfNextDecade(
  date
) {
  var offset =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
...
var getDateString = (exports.getDateString = function getDateString(date) {
  ...
  var string_month = getMonthString(month);

  return day +" "+ string_month +" "+ year;
});

var getMonthString = (exports.getMonthString = function getMonthString(month) {
  switch (month) {
    case "01":
      return "January";
    case "02":
...
var getBeginOfPreviousYear = (exports.getBeginOfPreviousYear = function getBeginOfPreviousYear(
  date
) {
  var offset =
...
var getEndOfPreviousYear = (exports.getEndOfPreviousYear = function getEndOfPreviousYear(
  date
) {
  var offset =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
...
var getBeginOfNextYear = (exports.getBeginOfNextYear = function getBeginOfNextYear(
  date
) {
  var offset =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
 ...
 * @param {Date} date Date.
 */
var getBeginOfMonth = (exports.getBeginOfMonth = function getBeginOfMonth(
  date
) {
  var year = getYear(date);
...
var getBeginOfPreviousMonth = (exports.getBeginOfPreviousMonth = function getBeginOfPreviousMonth(
  date
) {
  var offset =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
...
var getEndOfPreviousMonth = (exports.getEndOfPreviousMonth = function getEndOfPreviousMonth(
  date
) {
  var offset =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
...
var getBeginOfNextMonth = (exports.getBeginOfNextMonth = function getBeginOfNextMonth(
  date
) {
  var offset =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
...
var getBeginPrevious = (exports.getBeginPrevious = function getBeginPrevious(
  rangeType,
  date
) {
  switch (rangeType) {
...
var getBeginNext = (exports.getBeginNext = function getBeginNext(
  rangeType,
  date
) {
  switch (rangeType) {
...
var getBeginPrevious2 = (exports.getBeginPrevious2 = function getBeginPrevious2(
  rangeType,
  date
) {
  switch (rangeType) {
...
var getBeginNext2 = (exports.getBeginNext2 = function getBeginNext2(
  rangeType,
  date
) {
  switch (rangeType) {
...
var getEndPrevious = (exports.getEndPrevious = function getEndPrevious(
  rangeType,
  date
) {
  switch (rangeType) {
...
var getEndPrevious2 = (exports.getEndPrevious2 = function getEndPrevious2(
  rangeType,
  date
) {
  switch (rangeType) {
 ...
 */
var getValueRange = (exports.getValueRange = function getValueRange(
  rangeType,
  date1,
  date2
) {
 ...
 */
var getCenturyLabel = (exports.getCenturyLabel = function getCenturyLabel(
  date
) {
 ...
 */
var getISOLocalMonth = (exports.getISOLocalMonth = function getISOLocalMonth(
  value
) {
  if (!value) {
    return value;
 ...
 */
var getISOLocalDate = (exports.getISOLocalDate = function getISOLocalDate(
  value
) {
  if (!value) {
    return value;
